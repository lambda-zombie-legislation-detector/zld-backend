...
import com.legicycle.backend.services.RoleService;
...
public class RolesController
{
    ...
    public ResponseEntity<?> addUserRole(@PathVariable
    ...
    public ResponseEntity<?> deleteUserRole(@PathVariable
            long userid, @PathVariable
            long roleid)
    {
